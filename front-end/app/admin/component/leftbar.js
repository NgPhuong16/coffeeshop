        ...
        <>
            <ul className="nav nav-pills flex-column mb-auto" data-bs-themes>
                <li className="nav-item">
                    <Link href="/admin" className={`nav-link  rounded-0 ${pathname == "/admin" ? "active link-dark" : "text-white"}`}>
                        <i className="far fa-tachometer-alt-fastest fa-fw"></i>
                        <span className="d-none d-sm-inline-block">Dashboard</span>
                    </Link>
                </li>
                <li>
                    <Link href="/admin/order" className={`nav-link  rounded-0 ${pathname == "/admin/order" ? "active link-dark" : "text-white"}`}>
                        <i className="far fa-shopping-cart fa-fw"></i>
                        <span className="d-none d-sm-inline-block">Orders</span>
                    </Link>
                </li>
                <li>
                    <Link href="/admin/product" className={`nav-link  rounded-0 ${pathname == "/admin/product" ? "active link-dark" : "text-white"}`}>
                        <i className="far fa-boxes fa-fw"></i>
                        <span className="d-none d-sm-inline-block">Products</span>
                    </Link>
                </li>
                <li>
                    <Link href="/admin/customer" className={`nav-link  rounded-0 ${pathname == "/admin/customer" ? "active link-dark" : "text-white"}`}>
                        <i className="far fa-users fa-fw"></i>
                        <span className="d-none d-sm-inline-block">Customers</span>
                    </Link>
                </li>
                <li>
                    <Link href="/admin/rating" className={`nav-link  rounded-0 ${pathname == "/admin/rating" ? "active link-dark" : "text-white"}`}>

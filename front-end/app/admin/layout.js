    ...
    <html lang="vi">
      <body style={{ background: "#eff8ff" }}>
        <div className="d-flex min-vh-100">
          <div className="d-flex flex-column flex-shrink-0 p-3 text-bg-dark" style={{ maxWidth: 280 + 'px' }} data-bs-theme="dark">
            <Link href="/admin" className="d-flex align-items-center mb-3 mb-md-0 me-md-auto text-white text-decoration-none justify-content-center">
          ...
          <div className="w-100">
            <nav className="navbar navbar-expand-md text-bg-dark" data-bs-theme="dark">
              <div className="container-fluid ps-0">
                <div className="d-flex justify-content-between w-100">
                  <form className="d-flex w-100" role="search" data-bs-theme="light">
                    <div className="input-group">
                      <button type="submit" className="btn btn-dark rounded-0 border-white">
                  ...
                  <ul className="navbar-nav ms-auto" data-bs-theme="light">
                    <li className="nav-item dropdown">
                      ...
                      <ul className="dropdown-menu rounded-0 dropdown-menu-md-end">
                        ...
                        <li><Link className="dropdown-item" href="#">Settings action</Link></li>
